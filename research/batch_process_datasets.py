#!/usr/bin/env python3
"""
Batch OCR Processing for Local Datasets
Process all images in datasets folder and save results to CSV
"""
...
OUTPUT_CSV = f"/home/miew/Documents/Project/ocr-ecosteps/research/ocr_validation_{datetime.now().strftime('%Y%m%d_%H%M%S')}.csv"
...
def process_batch():
    ...
    print("="*80)
    print("🔬 OCR BATCH PROCESSING - RESEARCH & VALIDATION")
    print("="*80)
    ...
    for idx, img_info in enumerate(images, 1):
        ...
        try:
            # Process OCR
            result = process_ocr_local(file_path, category)
